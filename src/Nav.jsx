		...
		<nav className="navigation">
			<div className="navigation-inner container">
				<a className="navigation-item navigation-item--logo" href="/">
					<svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 40 40" class="hidden-print">
						<path
						...
						<path
							...
							fill="#FF6555"
						></path>
						<path d="M25.519 25.594v-10.3a.666.666 0 00-.666-.665H14.567v10.965h10.952z" fill="#FF6555"></path>
					</svg>
				</a>
            ...
            Partner rotators
				...
				<div className="navigation-item">
					<div className="btn btn--profile">
						<img src="https://d3nkmyl4psgrha.cloudfront.net/avatars/pobrane 4jpg-1613479689991.jpeg" alt="user"></img>
					</div>
				</div>
			</div>
		</nav>
